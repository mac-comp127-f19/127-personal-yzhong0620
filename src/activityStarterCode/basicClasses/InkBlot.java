...
public class InkBlot {
    ...
    public void generateInkBlot() {
        RandomWalk rw1 = new RandomWalk(150);
        RandomWalk rw2 = new RandomWalk(150);
        RandomWalk red = new RandomWalk(150);
        RandomWalk green = new RandomWalk(150);
        RandomWalk blue = new RandomWalk(150);
        for (int i=0;i<15000;i++){
            Line line1 = advance(rw1,rw2);
            line1.setStrokeColor(getColor(red,green,blue));
            Line line2 = mirror(line1);
            line2.setStrokeColor(getColor(red,green,blue));
            canvas.add(line1);
            canvas.add(line2);
        }
